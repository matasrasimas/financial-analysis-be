...
public class RetrieveSentInvitationsInteractorTest {
    ...
    private RetrieveSentInvitationsUseCase interactor;

    @BeforeEach
    void setUp() {
        interactor = new RetrieveSentInvitationsInteractor(invitationGateway, invitationD2BConverter);
    }

    @Test
    void executeShouldReturnSentInvitationsWhenFound() {
        ...
        // Mock behavior
        when(invitationGateway.retrieveSentInvitations(any())).thenReturn(invitations);
        ...
        verify(invitationGateway).retrieveSentInvitations(any());
