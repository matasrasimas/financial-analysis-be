...
public class RetrieveSentInvitationsRoute extends AuthedRoute<List<BoundaryInvitation>, List<RestInvitation>> {
    ...
    public RetrieveSentInvitationsRoute(AuthenticationUseCaseFactory authUCFactory,
    ...
    protected Single<List<BoundaryInvitation>> processAuthedRequest(RequestWrapper request) {
        ...
        return invitationUseCaseFactory.createRetrieveSentInvitationsUseCase().execute(userId);
    }
}
