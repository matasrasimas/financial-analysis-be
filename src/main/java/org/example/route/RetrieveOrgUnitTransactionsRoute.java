...
public class RetrieveOrgUnitTransactionsRoute extends AuthedRoute<List<BoundaryTransaction>, List<RestTransaction>> {
    ...
    public RetrieveOrgUnitTransactionsRoute(AuthenticationUseCaseFactory authUCFactory,
    ...
    protected Single<List<BoundaryTransaction>> processAuthedRequest(RequestWrapper request) {
        ...
        return transactionUseCaseFactory.createRetrieveOrgUnitTransactionsUseCase().execute(orgUnitId, from, to);
    }
}
